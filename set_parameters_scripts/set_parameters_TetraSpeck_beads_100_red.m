function params = set_parameters_TetraSpeck_beads_100_red
...
params.lambda = 685; % emission central wavelength
params.lambdacentral = 685;
params.lambdaspread = [672.5,697.5];
