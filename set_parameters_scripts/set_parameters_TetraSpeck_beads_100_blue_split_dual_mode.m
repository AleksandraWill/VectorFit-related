function params = set_parameters_TetraSpeck_beads_100_blue_split_dual_mode
...
params.lambda = 525; % emission central wavelength
params.lambdacentral = 525;
params.lambdaspread = [502.5,547.5];
