function params = set_parameters_TetraSpeck_beads_100_blue
...
if params.select_spots
    params.Ncfg_global = 13; % selection out of Ncfg for global update
...
params.segmentation_ROI_thr = 50; % segmentation threshold
...
params.lambda = 538; % emission central wavelength
params.lambdacentral = 538;
params.lambdaspread = [525.5,550.5];
