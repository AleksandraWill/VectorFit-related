function params = set_parameters_TetraSpeck_beads_100_red_split_dual_mode
...
params.lambda = 700; % emission central wavelength
params.lambdacentral = 700;
params.lambdaspread = [662.5,737.5];
