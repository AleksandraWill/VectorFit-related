...
path_input_data = 'C:\Users\Aleksandra\Libraries\vectorfit\data\beads_red_blue_split\avg_pos2_red_blue_split.tif';

% Folder where the results will be stored
path_output_data = 'C:\Users\Aleksandra\Libraries\vectorfit\data\beads_red_blue_split\';
params = set_parameters_TetraSpeck_beads_100_blue_split_dual_mode;
...
for file_i=1:nr_of_files
    ...
    % Crop to upper half
    img_cropped = img(1:256, :, :); % Now img_cropped is 256x512xMz
